...
class Mapos_model extends CI_Model {
    ...
    function pesquisar($termo){
        ...
        // buscando os
         ...
         $this->db->or_like('usuario',$termo);
         $this->db->or_like('eqid',$termo);
         $this->db->limit(5);
    ...
    function pesquisar2($termoeqid){
         $data = array();
        // buscando clientes
         $this->db->like('nomeCliente',$termoeqid);
         $this->db->limit(5);
         $data['clientes'] = $this->db->get('clientes')->result();

        // buscando os
         $this->db->like('idOs',$termoeqid);
         $this->db->limit(5);
         $data['os'] = $this->db->get('os')->result();
         
         
        $this->db->like('eqid',$termoeqid);
        $this->db->limit(5);
        $data['produtos'] = $this->db->get('produtos')->result();         
         
                 
         //buscando serviços
         $this->db->like('nome',$termoeqid);
         $this->db->limit(5);
         $data['servicos'] = $this->db->get('servicos')->result();
